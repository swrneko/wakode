...
**Зачем.** SQLite допускает одного писателя. Если каждый HTTP-обработчик пишет сам, они дерутся за блокировку и получают `SQLITE_BUSY`. Единственная пишущая задача убирает борьбу целиком.
